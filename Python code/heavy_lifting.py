...
async def main():
    ...
    await motor.run_for_time(port.C, 4000, -500) # spin gear (lift the flag up)
    await runloop.sleep_ms(1500)

    await motor.run_for_degrees(port.D, 630, -600) #turn right
    #//await runloop.sleep_ms(1500)
    ...
    motor_pair.move(motor_pair.PAIR_1,0,velocity= 1000)
    await runloop.sleep_ms(1200)#waits for 2 seconds
    motor_pair.stop(motor_pair.PAIR_1)
